    ...
    <>
      {
        <li
          key={user?._id}
          className="duration-3000 mb-1 flex h-auto w-full items-center justify-between rounded-md border-[0.3px] border-gray-500/10 px-4 py-1 pr-6 transition-all hover:shadow-md hover:shadow-gray-500/20 dark:border-gray-500/10 dark:bg-dark-bg-b dark:hover:shadow-gray-500/20"
        >
